...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        //syncCube.transform.position = qrCodeObject.transform.position;
                        syncCube.GetComponent<SpatialGraphCoordinateSystem>().Id = action.qrCode.SpatialGraphNodeId;
        ...
        {
            syncCube.GetComponent<SpatialGraphCoordinateSystem>().enabled = !syncCube.GetComponent<SpatialGraphCoordinateSystem>().enabled;
        }
